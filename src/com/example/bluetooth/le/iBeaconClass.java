...
//    		return distance;
 //  	}
    ...
    public static iBeacon fromScanData(BluetoothDevice device, int rssi,byte[] scanData,SQLiteDatabase database) {
...
//		//将相应设备的rssi写入到数据库
//		openHelper = new MySQLiteOpenHelper(mContext, 1);
//		//创建数据库
